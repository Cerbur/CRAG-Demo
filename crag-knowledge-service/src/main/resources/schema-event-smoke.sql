-- Knowledge smoke event tables (plan_17/17.4).
-- Created in the knowledge schema (currentSchema=knowledge) only for the smoke event closed loop.
-- These hold test events only; they are not business tables and may keep harmless residue on rollback.
