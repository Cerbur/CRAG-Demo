...
| plan_14 | 多服务骨架、gRPC 契约与身份、独立 Schema、五进程 Docker 基线 | ⏳ 进行中 (0/5, 3 待验收) | — | [plan_14.md](../plan_14/plan_14.md) |
...
| 文件 | 主要功能 | 状态 |
| --- | --- | --- |
| [plan_14.md](../plan_14/plan_14.md) | 多服务骨架、Protobuf/gRPC、服务身份、独立 Schema、五进程 Compose 与兼容回归 | ⏳ 进行中 (0/5, 3 待验收) |
