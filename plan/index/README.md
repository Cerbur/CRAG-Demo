...
| plan_10 | Docker 正式健康检查与部署验收，包含 Actuator probes、双 App 并存、故障恢复和持久化回归 | 🔍 待验收 (1/3) | — | [plan_10.md](../plan_10/plan_10.md) |
...
| 文件 | 主要功能 | 状态 |
| --- | --- | --- |
| [plan_10.md](../plan_10/plan_10.md) | Docker 正式健康检查与部署验收，包含 Actuator probes、Compose readiness、默认/Smoke 并存、数据库故障恢复和持久化回归 | 🔍 待验收 (1/3) |
