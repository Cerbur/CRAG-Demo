...
> 最后更新：2026-06-20 (plan_6.hotfix_6 第三次验收未完成：Docker 通过，断言与交接待修正)
...
| plan_6 | Retrieval 查询链路，完成 Sparse/Dense/RRF/Rerank | ✅ 完成 | [plan_6.hotfix_6](../plan_6/plan_6.hotfix_6.md) 进行中 (2/3) — Docker 已通过，matchedChildIds 全量断言与正式交接待修正 | [plan_6.md](../plan_6/plan_6.md) |
...
- `plan_6.hotfix_6` 真实 Docker 回归已通过，但自动化断言与 workflow v3 交接尚未完成，继续阻止 `plan_13`。
...
| [plan_6.hotfix_6.md](../plan_6/plan_6.hotfix_6.md) | 新增 parent evidence 公共入口，区分真实命中与相邻扩展并返回完整 parent Context | 🚧 进行中 (2/3) |
