...
| plan_9 | Java 模块边界收紧，包含 crag-api、公开 API 包、crag-smoke 与 ArchUnit | 🔄 进行中 (0/6)，plan_11 已完成 | — | [plan_9.md](../plan_9/plan_9.md) |
...
| 文件 | 主要功能 | 状态 |
| --- | --- | --- |
| [plan_9.md](../plan_9/plan_9.md) | Java 模块边界收紧，包含 crag-api 重命名、公开 API 包、Embedding 契约、crag-smoke 和 ArchUnit | 🔄 进行中 (0/6)，plan_11 已完成 |
