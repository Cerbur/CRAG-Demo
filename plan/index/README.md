...
| plan_9 | Java 模块边界收紧，包含 crag-api、公开 API 包、crag-smoke 与 ArchUnit | ✅ 完成 (6/6) | [plan_9.hotfix_2](../plan_9/plan_9.hotfix_2.md)：⏳ 待开始 (0/1) | [plan_9.md](../plan_9/plan_9.md) |
...
| [plan_9.hotfix_2.md](../plan_9/plan_9.hotfix_2.md) | 收敛模块与 API 约束中的过期实现事实和已完成迁移历史 | ⏳ 待开始 (0/1) |
