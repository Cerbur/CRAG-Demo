...
> 最后更新：2026-06-23（plan_14 验收发现 Access/Knowledge 启动后退出，追加 14.14）
...
| plan_14 | 多服务骨架、gRPC 契约与身份、独立 Schema、五进程 Docker 基线 | 🔍 待验收 (0/14) | — | [plan_14.md](../plan_14/plan_14.md) |
...
```text
plan_14（多服务骨架、gRPC 契约与身份、独立 Schema、五进程 Docker 基线）
```
...
| 文件 | 主要功能 | 状态 |
| --- | --- | --- |
| [plan_14.md](../plan_14/plan_14.md) | 多服务骨架、Protobuf/gRPC、服务身份、独立 Schema、五进程 Compose 与兼容回归 | 🔍 待验收 (0/14) |
