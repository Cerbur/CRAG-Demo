...
| plan_11 | 测试分层与回归工作流治理，包含 Component/Architecture 分类、Docker HTTP 回归和验收规则 | 🔄 进行中 (2/4) | — | [plan_11.md](../plan_11/plan_11.md) |
...
| 文件 | 主要功能 | 状态 |
| --- | --- | --- |
| [plan_11.md](../plan_11/plan_11.md) | 测试分层与回归工作流治理，包含轻量组件测试、架构测试、Docker HTTP 回归、数据隔离与验收规则 | 🔄 进行中 (2/4) |
