...
> 最后更新：2026-07-02（plan_22 执行中：22.1–22.6 实现提交 a1582767/bafd53aa/3657150d/d9ca25e4+35256a1f/af064df+f24e598+45693d0 转待验收）
...
| plan_22 | Web Console、MVVM 前端、Knowledge/Document/API Key 管理、Chat 与 Node Docker 开箱部署 | 🟡 进行中 (0/9) | — | [plan_22.md](../plan_22/plan_22.md) |
...
```text
1. plan_22 — Web Console 与开箱即用部署（in_progress，0/9，22.1–22.6 待验收）
```
...
| [plan_7.hotfix_1.md](../plan_7/plan_7.hotfix_1.md) | Query Stub success/failure 回归迁移到 Knowledge 上传与 ingestion READY evidence，确保 failure 路径（502）可达 | ✅ 完成 (2/2) |
...
| 文件 | 主要功能 | 状态 |
| --- | --- | --- |
| [plan_16.md](../plan_16/plan_16.md) | RAG Service Module 收口与 Smoke HTTP 入口重整，合并 `crag-storage` / `crag-retrieval` / `crag-query` / `crag-ingestion` / `crag-api` / `crag-smoke` 到 `crag-rag-service` 并统一 legacy HTTP smoke URI | ✅ 完成 (5/5) |
...
| 文件 | 主要功能 | 状态 |
| --- | --- | --- |
| [plan_22.md](../plan_22/plan_22.md) | React + Ant Design Web Console、MVVM 前端、核心管理/Chat 与 Node Docker 部署 | 🟡 进行中 (0/9) |
