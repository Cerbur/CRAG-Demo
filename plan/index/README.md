...
> 最后更新：2026-06-22 (plan_10 第一次独立验收未通过，退回修复 readiness 有界轮询)
...
| plan_10 | Docker 正式健康检查与部署验收，包含 Actuator probes、双 App 并存、故障恢复和持久化回归 | 🚧 进行中 (2/3) | — | [plan_10.md](../plan_10/plan_10.md) |
...
- `plan_10` 第一次独立验收发现 readiness 故障检测缺少请求超时与有上限轮询，已修复 10.2，待验收。
