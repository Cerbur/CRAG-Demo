...
> 最后更新：2026-06-19 (plan_9.hotfix_5 待开始)
...
| plan_9 | Java 模块边界收紧，包含 crag-api、公开 API 包、crag-smoke 与 ArchUnit | ✅ 完成 (6/6) | [plan_9.hotfix_5](../plan_9/plan_9.hotfix_5.md) 🟡 待开始 (0/1) | [plan_9.md](../plan_9/plan_9.md) |
...
```text
plan_9.hotfix_5 → plan_7 → plan_10
```

- 同一时刻默认只执行队首计划；前置计划完成后才推进下一项。
- `plan_9.hotfix_5` 正在闭合异常处理组件测试的 MVC Slice 验收；完成后继续执行 Query 链路与完整 Docker 部署治理。
...
| [plan_9.hotfix_5.md](../plan_9/plan_9.hotfix_5.md) | 四类异常测试迁移到 @WebMvcTest | 🟡 待开始 (0/1) |
