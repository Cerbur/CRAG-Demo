...
> 最后更新：2026-06-23（plan_14 独立验收退回，追加 14.11-14.12）
...
| plan_14 | 多服务骨架、gRPC 契约与身份、独立 Schema、五进程 Docker 基线 | 🚧 进行中 (0/12) | — | [plan_14.md](../plan_14/plan_14.md) |
...
```text
plan_14（进行中：修复 Probe 身份/超时语义与平台拓扑验收）
```
