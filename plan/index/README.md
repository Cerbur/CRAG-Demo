...
| plan_9 | Java 模块边界收紧，包含 crag-api、公开 API 包、crag-smoke 与 ArchUnit | ✅ 完成 (6/6) | [plan_9.hotfix_2](../plan_9/plan_9.hotfix_2.md)：🚧 进行中 (0/1) | [plan_9.md](../plan_9/plan_9.md) |
...
```text
plan_9.hotfix_2 → plan_7 → plan_10
```

- 同一时刻默认只执行队首计划；前置计划完成后才推进下一项。
- `plan_9.hotfix_2` 收敛模块与 API 约束中的过期事实；完成后继续校准 plan_7。
...
| [plan_9.hotfix_2.md](../plan_9/plan_9.hotfix_2.md) | 收敛模块与 API 约束中的过期实现事实和已完成迁移历史 | 🚧 进行中 (0/1) |
