...
| 编号 | 任务 | 状态 | 提交 | 完成时间 |
| --- | --- | --- | --- | --- |
| 1.1 | 初始化 Gradle 项目（Kotlin DSL），配置依赖 | ✅ 完成 | `____` | 2026-06-10 |
| 1.2 | 创建 Application 启动类 | ✅ 完成 | `____` | 2026-06-10 |
| 1.3 | 编写 application.yml 基础配置 | ✅ 完成 | `____` | 2026-06-10 |
| 2.1 | 创建 controller/ 包 | ✅ 完成 | `____` | 2026-06-10 |
| 2.2 | 创建 service/ 包 | ✅ 完成 | `____` | 2026-06-10 |
| 2.3 | 创建 core/ 包（6 个子包骨架） | ✅ 完成 | `____` | 2026-06-10 |
| 2.4 | 创建 dao/ 包（数据访问层骨架） | ✅ 完成 | `____` | 2026-06-10 |
| 2.5 | 创建 integration/ 包（3 个子包骨架） | ✅ 完成 | `____` | 2026-06-10 |
| 3.1 | 引入 pgvector 支持 | ✅ 完成 | `____` | 2026-06-10 |
| 3.2 | 创建 Chunk Entity | ✅ 完成 | `____` | 2026-06-10 |
| 3.3 | 创建 ChunkRepository | ✅ 完成 | `____` | 2026-06-10 |
| 3.4 | 编写 schema.sql（chunk 表 DDL） | ✅ 完成 | `____` | 2026-06-10 |
| 3.5 | 编写 data.sql（测试种子数据） | ✅ 完成 | `____` | 2026-06-10 |
| 4.1 | 编写 Dockerfile（多阶段构建） | ✅ 完成 | `____` | 2026-06-10 |
| 4.2 | 编写 docker-compose.yml | ✅ 完成 | `____` | 2026-06-10 |
| 4.3 | 编写 .dockerignore | ✅ 完成 | `____` | 2026-06-10 |
