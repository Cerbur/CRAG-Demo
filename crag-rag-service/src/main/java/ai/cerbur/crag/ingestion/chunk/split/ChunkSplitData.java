 ...
 *
 * <p>用于 ChunkSplitService 内部分块结果传递，不直接持久化. child 的 chunkIndex 为在 parent 内的序号（0-based），parent 的
 * chunkIndex 为在文档中的序号（0-based）.
 *
 ...
 * @since 2026-06-12
 */
public record ChunkSplitData(String content, int tokenCount, Integer chunkIndex) {}
