...
public interface ChunkRepository extends JpaRepository<Chunk, String> {
     ...
     * @return 候选 chunk 列表
     */
    @Query("SELECT c FROM Chunk c WHERE c.parentChunkId <> '' AND (c.denseStatus IN :statuses OR (c.denseStatus = ai.cerbur.crag.storage.entity.ChunkStatus.PROCESSING AND c.updatedAt < :timeoutThreshold)) ORDER BY c.updatedAt ASC")
    ...
    @Modifying
    @Transactional
    @Query("UPDATE Chunk c SET c.denseStatus = ai.cerbur.crag.storage.entity.ChunkStatus.PROCESSING, c.updatedAt = CURRENT_TIMESTAMP, c.version = c.version + 1 WHERE c.chunkId = :chunkId AND c.denseStatus = :expectedStatus AND c.version = :version")
    ...
    @Modifying
    @Transactional
    @Query("UPDATE Chunk c SET c.denseStatus = ai.cerbur.crag.storage.entity.ChunkStatus.PROCESSING, c.updatedAt = CURRENT_TIMESTAMP, c.version = c.version + 1 WHERE c.chunkId = :chunkId AND c.denseStatus = ai.cerbur.crag.storage.entity.ChunkStatus.PROCESSING AND c.updatedAt < :timeoutThreshold AND c.version = :version")
    ...
    @Modifying
    @Transactional
    @Query("UPDATE Chunk c SET c.denseStatus = :newStatus, c.updatedAt = CURRENT_TIMESTAMP, c.version = c.version + 1 WHERE c.chunkId = :chunkId AND c.denseStatus = ai.cerbur.crag.storage.entity.ChunkStatus.PROCESSING AND c.version = :version")
     ...
     * @return 候选 chunk 列表
     */
    @Query("SELECT c FROM Chunk c WHERE c.parentChunkId <> '' AND (c.sparseStatus IN :statuses OR (c.sparseStatus = ai.cerbur.crag.storage.entity.ChunkStatus.PROCESSING AND c.updatedAt < :timeoutThreshold)) ORDER BY c.updatedAt ASC")
    ...
    @Modifying
    @Transactional
    @Query("UPDATE Chunk c SET c.sparseStatus = ai.cerbur.crag.storage.entity.ChunkStatus.PROCESSING, c.updatedAt = CURRENT_TIMESTAMP, c.version = c.version + 1 WHERE c.chunkId = :chunkId AND c.sparseStatus = :expectedStatus AND c.version = :version")
    ...
    @Modifying
    @Transactional
    @Query("UPDATE Chunk c SET c.sparseStatus = ai.cerbur.crag.storage.entity.ChunkStatus.PROCESSING, c.updatedAt = CURRENT_TIMESTAMP, c.version = c.version + 1 WHERE c.chunkId = :chunkId AND c.sparseStatus = ai.cerbur.crag.storage.entity.ChunkStatus.PROCESSING AND c.updatedAt < :timeoutThreshold AND c.version = :version")
    ...
    @Modifying
    @Transactional
    @Query("UPDATE Chunk c SET c.sparseStatus = :newStatus, c.updatedAt = CURRENT_TIMESTAMP, c.version = c.version + 1 WHERE c.chunkId = :chunkId AND c.sparseStatus = ai.cerbur.crag.storage.entity.ChunkStatus.PROCESSING AND c.version = :version")
