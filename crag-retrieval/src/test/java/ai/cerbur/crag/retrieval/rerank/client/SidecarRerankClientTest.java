 ...
 *
 * RestClient HTTP 调用部分需集成测试覆盖，单测聚焦参数校验.
 *
 * @since 2026-06-15
 */
...
class SidecarRerankClientTest {
    ...
    /**
     * 手动构造的客户端实例，未经过 Spring @PostConstruct 初始化 RestClient，
     * 因此仅测试 rerank 方法的输入保护（不依赖 sidecar 连接）.
     */
