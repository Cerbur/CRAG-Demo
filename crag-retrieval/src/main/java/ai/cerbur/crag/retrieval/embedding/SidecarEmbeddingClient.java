 ...
 * 异常时抛出 EmbeddingException，由上层 Cron 捕获并标记 chunk dense_status = FAILED.
 *
 * @since 2026-06-13
 */
@Service
public class SidecarEmbeddingClient implements EmbeddingClient {
    ...
    void init() {
        ...
        log.info("SidecarEmbeddingClient initialized — baseUrl={}, connectTimeout={}, readTimeout={}",
    ...
    public float[] embed(String text) {
        ...
        try {
            ...
            throw new EmbeddingException(
                "Embedding request failed: " + e.getMessage(), e);
        }
    }
