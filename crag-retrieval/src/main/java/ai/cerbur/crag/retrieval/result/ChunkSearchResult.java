 ...
 * </pre>
 *
 * 由 Rerank 阶段通过 {@link #fromRrfWithRerank(RrfFusionResult, double)} 组装，
 * 在 {@code RetrievalService} 中作为查询链路对外返回结果，通过组合保留 chunk 业务信息.
 *
 * @since 2026-06-15
 */
public class ChunkSearchResult {
    ...
    private ChunkSearchResult(ChunkBO chunk, Double sparseScore, Double denseScore,
