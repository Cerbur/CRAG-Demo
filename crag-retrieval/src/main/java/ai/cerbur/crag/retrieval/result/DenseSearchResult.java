 ...
 *
 * 这是检索管道中最内层的窄类型，组合 {@link ChunkBO} 并只新增 Dense 阶段自己产出的得分.
 * 下游 RRF 融合阶段消费此类型并产出更宽的 {@link RrfFusionResult}.
 *
 * @since 2026-06-17
 */
public class DenseSearchResult {
    ...
    public DenseSearchResult(String chunkId, String parentChunkId, double denseScore, String content) {
        this(chunkId, parentChunkId, null, denseScore, content);
    }

    public DenseSearchResult(String chunkId, String parentChunkId, Integer chunkIndex,
                             double denseScore, String content) {
